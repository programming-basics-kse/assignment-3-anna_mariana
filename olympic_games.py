...
if args.interactive:
    ...
    while True:
        ...
        country_stats = [line for line in input_table if line[6] == task or line[7] == task]
        if not country_stats:
            print(f"No data available for '{task}'. Please try again.")
            continue
        ...
        if total_olympics > 0:
            ...
            average_gold = average_silver = average_bronze = 0
